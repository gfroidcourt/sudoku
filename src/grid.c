...
bool grid_check_char(const grid_t *grid, const char c)
{
  ...
  {
  case 64:
    return (c >= '1' && c <= '9') || (c >= 'A' && c <= 'Z') || c == '@' || (c >= 'a' && c <= 'z') || c == '&' || c == '*' || c == '_';
  case 49:
    return (c >= '1' && c <= '9') || (c >= 'A' && c <= 'Z') || c == '@' || (c >= 'a' && c <= 'm') || c == '_';
  case 36:
    return (c >= '1' && c <= '9') || (c >= 'A' && c <= 'Z') || c == '@' || c == '_';
  case 25:
...
void fill_subgrid(const grid_t *grid, colors_t *subgrid, const char *type,
                  size_t index)
{
